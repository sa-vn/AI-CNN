...
# CNN 4-Layer - Batchsize 128 - Lr 0.001
...
# Load datasets
train_dataset = torchvision.datasets.ImageFolder(root='/content/drive/MyDrive/COMP6721 - Dataset/train', transform=train_transform)
val_dataset = torchvision.datasets.ImageFolder(root='/content/drive/MyDrive/COMP6721 - Dataset/val', transform=val_test_transform)
test_dataset = torchvision.datasets.ImageFolder(root='/content/drive/MyDrive/COMP6721 - Dataset/test', transform=val_test_transform)
...
optimizer = optim.Adam(model.parameters(), lr=0.001)  # Reduced learning rate for better performance
...
save_dir = '/content/drive/MyDrive/COMP6721 - Dataset'
