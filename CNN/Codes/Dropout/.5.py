...
# Load datasets
train_dataset = torchvision.datasets.ImageFolder(root='/content/drive/MyDrive/ColabNotebooks/DataSet/train', transform=train_transform)
val_dataset = torchvision.datasets.ImageFolder(root='/content/drive/MyDrive/ColabNotebooks/DataSet/val', transform=val_test_transform)
test_dataset = torchvision.datasets.ImageFolder(root='/content/drive/MyDrive/ColabNotebooks/DataSet/test', transform=val_test_transform)
...
class ImprovedCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.pool(self.batch_norm6(torch.relu(self.conv6(x))))  # Additional layer forward
